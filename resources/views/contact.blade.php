    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-4">
            ...
            <p class="text-lg">
                ...
                <span class="font-semibold">Adresse :</span>Rue Louis Hap 16, 1040 Etterbeek
            </p>
            <p class="text-lg">
                <i class="fas fa-map-marker-alt text-primary"></i>
                <span class="font-semibold">Liens directs:</span>
            </p>
            <div class="text-lg">
                <i class="fas fa-clock text-primary"></i>
                <p class="font-semibold">Heures de bureau:</p>
            ...
            <p class="text-lg flex items-center">
                ...
                <a href="https://wa.me/3221234567?text=Bonjour%2C%20je%20souhaite%20plus%20d%27informations." class="text-primary hover:underline font-semibold ml-1">Chattez avec nous sur WhatsApp</a>
            </p>
        </div>
